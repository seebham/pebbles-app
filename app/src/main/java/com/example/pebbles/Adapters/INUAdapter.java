...
import com.example.pebbles.ImpNotUrg;
...
public class INUAdapter extends RecyclerView.Adapter<INUAdapter.ViewHolder> {
    private List<ToDoModel> todoList;
    private ImpNotUrg activity;
    private DatabaseHandler db;
    private static final String tableName = "inu";

    public INUAdapter(DatabaseHandler db, ImpNotUrg activity) {
        this.db = db;
