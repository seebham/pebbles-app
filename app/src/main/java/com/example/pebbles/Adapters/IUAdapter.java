...
public class IUAdapter extends RecyclerView.Adapter<IUAdapter.ViewHolder> {
    private List<ToDoModel> todoList;
    private ImpUrg activity;
    private DatabaseHandler db;
    private static final String tableName = "iu";

    public IUAdapter(DatabaseHandler db, ImpUrg activity) {
        this.db = db;
